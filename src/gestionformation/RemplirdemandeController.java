 ...
 * @author mariem
 */
public class RemplirdemandeController implements Initializable {
    ...
    private boolean ajouterdemande() throws SQLException{
     ...
     @FXML protected void handleSubmitButtonAction(ActionEvent event) throws IOException, SQLException {
      boolean isAdded = this.ajouterdemande();
      if(isAdded){
          this.submitMsg.setText("Merci pour votre inscription !");
      }else{
